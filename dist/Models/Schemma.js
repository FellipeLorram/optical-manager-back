...
const ExamsSchemma = new _mongoose2.default.Schema({
...
const PaymentSchemma = new _mongoose2.default.Schema({
...
const SellsSchemma = new _mongoose2.default.Schema({
...
const ConcertsSchemma = new _mongoose2.default.Schema({
...
const ClientSchemma = new _mongoose2.default.Schema({
...
const SellersSchemma = new _mongoose2.default.Schema({
  nome: { type: String, required: true },
  idade: { type: String, required: false, default: '' },
  endereço: { type: String, required: false, default: '' },
  telefone: { type: String, required: false, default: '' },
...
const FramesSchemma = new _mongoose2.default.Schema({
...
const LensSchemma = new _mongoose2.default.Schema({
  name: { type: String, required: true },
  price: { type: String, required: false, default: '' },
  type: { type: String, required: false, default: '' },
});

const UserSchemma = new _mongoose2.default.Schema({
  nome: { type: String, required: true },
...
const UserModel = _mongoose2.default.model('User', UserSchemma);
